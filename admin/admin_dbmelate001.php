...
$modificar = filter_input(INPUT_GET, 'modificar', FILTER_SANITIZE_SPECIAL_CHARS);
$n_sorteo = filter_input(INPUT_GET, 'n_sorteo', FILTER_SANITIZE_SPECIAL_CHARS);

$xmonth = filter_input(INPUT_POST, 'xmonth', FILTER_SANITIZE_SPECIAL_CHARS);
$xyear = filter_input(INPUT_POST, 'xyear', FILTER_SANITIZE_SPECIAL_CHARS);
$xBnumSorteo = filter_input(INPUT_POST, 'xBnumSorteo', FILTER_SANITIZE_SPECIAL_CHARS);
...
$accion = 1; 
$tit_accion = 'Nuevo Registro de Datos del Sorteo Melate';
$sql_next_num_sorteo = "select sorteo+1 as numsorteo from skm.smdbmelate order by sorteo desc limit 1";
...
$accion = 2; 
$tit_accion = 'Actualizaci&oacute;n de Datos del Sorteo Melate';
$numsorteo = $n_sorteo;
$sql_busca_sorteo = "select * from skm.smdbmelate where sorteo = $n_sorteo";
$result_busca = mysql_query($sql_busca_sorteo, $db);
while ($fila = mysql_fetch_array($result_busca, MYSQL_ASSOC)) {
...
if  ($fila['resultado'] == 1) {
    ...
    $campo = array("fecha"=>$fila['fecha'], "nat1"=>$fila['comp1'], "nat2"=>$fila['comp2'], "nat3"=>$fila['comp3'], "nat4"=>$fila['comp4'], "nat5"=>$fila['comp5'], "nat6"=>$fila['comp6'], "adic"=>$fila['adicional'], "bolsa"=>$fila['bolsa']);
}
                                                 }
...
<script language="JavaScript">
  ...
  function cancelar_opcion() {
    window.location.href="admin_dbmelate001.php"
  }
...
?>
<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0" onload="MM_preloadImages('imagenes/titulo_adminmelate.gif','imagenes/busque_x_fecha.gif', 'imagenes/titulo_consult_melate.gif'); nuevaposicion()">
<?php
             }
  else {
?>
<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0" onLoad="MM_preloadImages('imagenes/titulo_adminmelate.gif','imagenes/busque_x_fecha.gif', 'imagenes/titulo_consult_melate.gif')">
<?php
        }
?>
 <center>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr><td align="center"><img src="imagenes/titulo_adminmelate.gif" align="center"></td></tr>
    <tr>
       <td vAlign="top">
	<table border="0" cellpadding="0" cellspacing="3">
                <form name="form_melate" action="admin_dbmelate002.php" action="post">                  
           ...
           if (isset($error)) {
             switch($error) {
                ...
                case 2: echo '<tr><td colspan="4" align="center" vAlign="middle">
                                  <table border="0" cellpadding="0" cellspacing="0"><tr>
                                  <td><b style="color:#ff9900">El n&uacute;mero de Sorteo '.$tmp_sorteo.' ya existe en la B.D. del Melate.</b></td>
				  <td>&nbsp;</td>
                                  <td><img src="imagenes/img_ok.gif" onClick="cancelar_opcion()" onMouseOver="this.style.cursor=\'hand\';"></td>
                                  </tr></table>
                              </td></tr>';
			  ...
			  <td>-</td>
   			  <td>
                            ...
                            <?php
                                for ($i=2011; $i < 2020; $i++) {   
                                      ?>
                               <option value="<?php echo $i; ?>" <?php echo $i == date("Y") ? "selected" : ""; ?>><?php echo $i; } ?>
			    </select>
                          </td>
                        </tr>
                      </table>
                ...
                <tr>
                    <td><b>1.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td><b>2.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td><b>3.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td><b>4.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td><b>5.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td><b>6.- N&uacute;mero Natural:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr><td bgcolor="#cccccc" background="../imagenes/bg_linea_punteada.gif" height="1" colspan="3"></td></tr>
                <tr>
                    <td><b>N&uacute;mero Adicional:</b></td>
                    <td>&nbsp;</td>
                    <td><input type="text" style="text-align='right';" onFocus="this.select();" name="xadicional" value="<?php if (isset($campo)) echo $campo['adic']; else echo '0'; ?>" size="2" maxlength="2"></td>
                </tr>
                <tr>
                    <td><b>Bolsa:</b></td>
                    <td>&nbsp;</td>
                ...
                <tr><td colspan="4"><?php
if (!isset($modificar)) { ?>
      <input type="button" class="button" value="Guardar" onClick="confirmar_submit_dbmelate(this.form,'Deseas Guardar el Nuevo Sorteo del Melate?')"><?php
                        }
else {?>
      <input type="button" class="button" value="Acutalizar" onClick="confirmar_submit(this.form,'¿Deseas Guardar los Nuevos Datos del Sorteo N&uacute;mero <?php echo $numsorteo; ?>?')">
      &nbsp;<input type="button" class="button" value="Eliminar" onClick="confirmar_submit_eliminar(this.form, '¿Deseas Eliminar el Sorteo N&uacaute;mero <?php echo $numsorteo; ?>?')">
    ...
    <tr>
      <td align="center">
           <table border="0" cellpadding="0" cellspacing="0" width="100%">
             <tr>
	     <td align="center"><img src="imagenes/titulo_consult_melate.gif"></td>
             </tr>  
...
<form action="admin_dbmelate001.php" method="post">
			  <tr>
...
<?php
   $sql_busca_year = "select year(fecha) as year from skm.smdbmelate group by year(fecha)";
...
?>
	            ...
	            <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="1" width="100%"><tr>
                           ...
                           <td align="center" width="40" bgcolor="#ffffff">ADIC</td> 
                        </tr></table>
                        </td>
                    </tr>
<?php
  ...
  if (isset($xyear) || isset($xBnumSorteo)) {
     if (isset($xmonth) && ($xmonth > 0)) {
       $sql_datos = "select * from smdbmelate where year(fecha) = $xyear ";
     ...
     if (isset($xBnumSorteo)) {
       $sql_datos = "select * from smdbmelate where sorteo = $xBnumSorteo"; 
     }
     $resultado_datos = mysql_query($sql_datos, $db);
     while ($fila = mysql_fetch_array($resultado_datos, MYSQL_ASSOC)) {
?>
	      <tr>
<td colspan="11">
                        <table border="0" cellpadding="0" cellspacing="1" width="100%"><tr>
                           <td align="center" width="60" bgcolor="#ffffff"><a href="admin_dbmelate001.php?modificar=si&n_sorteo=<?php echo $fila['sorteo']; ?>"><?php echo $fila['sorteo']; ?></a></td>  
		          ...
		          echo $mes[$m-1].'-'.$d;
                           ...
                           <td align="center" width="40" bgcolor="#ffffff"><?php echo $fila['adicional']; ?></td>  
                         </tr></table>
                        </tr>
<?php
                                                                                                         }
...
<?php
$sql_total_sorteos = "select count(sorteo) total from smdbmelate";
...
<?php
$sql_grafica = "select digito, count(digito) contador, (count(digito)*100)/$xtotal total  from smdbmelate group by digito";
$result_sql = mysql_query($sql_grafica, $db);
$contador=0;
while($fila = mysql_fetch_array($result_sql, MYSQL_ASSOC)) {
if (($contador % 2) == 0) {
  $bgColor = '#003366';
} else {
  $bgColor = '#006699';
