 ...
 switch($accion) {
    case 1: 
               for($i=1; $i<4; $i++) {
                    $xcampo1 = 'xganador' . $i;
                    $xcampo2 = 'xpremio' . $i;
                    $sql_insert = "insert into smresult_revancha set ";
               ...
               header("Location: admin_premiosrevancha001.php?confirmacion=1");
               break;
    case 2: 
               for($i=1; $i<4; $i++) {
                    $xcampo1 = 'xganador' . $i;
                    $xcampo2 = 'xpremio' . $i;
                    $sql_update = "update smresult_revancha set ";
               ...
               header("Location: admin_premiosrevancha001.php?confirmacion=2");
               break;
 }
                                                        }
