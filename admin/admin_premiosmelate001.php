...
$xnumsorteo = filter_input(INPUT_POST, 'xnumsorteo', FILTER_SANITIZE_SPECIAL_CHARS);    
...
<script language="JavaScript">
  ...
  function cancelar_opcion() {
    window.location.href='admin_premiosmelate001.php'
  }
...
<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
 <center>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td align="center">
       <img align="center" src="imagenes/titulo_ganadoresmelate.gif">
      </td>
    </tr>  
	...
	<table border="0" cellpadding="0" cellspacing="0" bgcolor="#eeeeee">
               <form action="admin_premiosmelate001.php" method="post">
	        <tr>
...
if (isset($xnumsorteo)) {
      $sql_busca_sorteo = "select sorteo from skm.smdbmelate where sorteo=$xnumsorteo";
      $resultado_busca_sorteo = mysql_query($sql_busca_sorteo, $db);
      if (mysql_num_rows($resultado_busca_sorteo)) {
         $sql_busca_premios = "select * from skm.smresult_sorteo where sorteo=$xnumsorteo";
         $resultado_busca_premios = mysql_query($sql_busca_premios, $db);
         if (!mysql_num_rows($resultado_busca_premios)) {
?>
<form action="admin_premiosmelate002.php" method="post">
...
<input type="hidden" name="xnumsorteo" value="<?php echo $xnumsorteo; ?>">
    ...
    <?php
       ...
       $aciertos[1] = 'Cinco n&uacute;meros m&aacute;s adicional';
       $aciertos[2] = 'Cinco n&uacute;meros naturales';
       $aciertos[3] = 'Cuatro n&uacute;meros naturales y el adicional';
       $aciertos[4] = 'Cuatro n&uacute;meros naturales';
       $aciertos[5] = 'Tres n&uacute;meros naturales y adicional';
       $aciertos[6] = 'Tres n&uacute;meros naturales';
    ?>
...
<?php
   $sql_busca_premios_sorteo = "select lugar, ganadores, premio from smresult_sorteo where sorteo = $xnumsorteo";
   $result_busca_premios_sorteo = mysql_query($sql_busca_premios_sorteo);
   $cont = 0;
   while ($fila = mysql_fetch_array($result_busca_premios_sorteo)) {
?>
          <tr>
             <td align="center"><?php echo $fila['lugar']; ?>.-</td>
             <td>&nbsp;<?php echo $aciertos[$cont]; ?></td>
