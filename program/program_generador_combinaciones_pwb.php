...
<div id="fondo" style="position:absolute;">
  <img src="imagenes/titulo_generador_pwb.png">
</div>
	       ...
	       <table border="0" cellpadding="0" cellspacing="3">
	          ...
	          <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" bordercolor="red">
                  ...
                  <form name="xrangos" action="program_generador_combinaciones_pwb.php" method="post"> 
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x1" class="casillapwd_nat" value="<?php if (isset($_POST['x1'])) { echo $_POST['x1']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x2" class="casillapwd_nat" value="<?php if (isset($_POST['x2'])) { echo $_POST['x2']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x3" class="casillapwd_nat" value="<?php if (isset($_POST['x3'])) { echo $_POST['x3']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x4" class="casillapwd_nat" value="<?php if (isset($_POST['x4'])) { echo $_POST['x4']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x5" class="casillapwd_nat" value="<?php if (isset($_POST['x5'])) { echo $_POST['x5']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="x6" class="casillapwd" value="<?php if (isset($_POST['x6'])) { echo $_POST['x6']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
    	      ...
    	      <tr>
                    ...
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y1" class="casillapwd_nat" value="<?php if (isset($_POST['y1'])) { echo $_POST['y1']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y2" class="casillapwd_nat" value="<?php if (isset($_POST['y2'])) { echo $_POST['y2']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y3" class="casillapwd_nat" value="<?php if (isset($_POST['y3'])) { echo $_POST['y3']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y4" class="casillapwd_nat" value="<?php if (isset($_POST['y4'])) { echo $_POST['y4']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb_nat.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y5" class="casillapwd_nat" value="<?php if (isset($_POST['y5'])) { echo $_POST['y5']; } else { echo ''; } ?>" size="2"></td>
                    <td>&nbsp;</td>
                    <td background="imagenes/img_casilla_pwb.png" height="40" width="40" align="center"><input type="text" onFocus="this.select();" maxlength="2" name="y6" class="casillapwd" value="<?php if (isset($_POST['y6'])) { echo $_POST['y6']; } else { echo ''; } ?>" size="2"></td>
    		<td>&nbsp;</td>
                     ...
                     <td colspan="20" align="center">
                       <table border="0" cellpadding="0" cellspacing="3">
                         <tr>
                           ...
                           <td align="center">
                               <a href="#" class="easyui-linkbutton" onClick="location.href='program_generador_combinaciones_pwb.php'">Limpiar Todo</a>
                           </td>                                                                   
                         </tr>
                       </table>
                     </td>
